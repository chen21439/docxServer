...
!(function (e, t) {
  ...
  var at,
              ...
              return u().wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 11:
                      if (
                        (he.isURLSearchParams(t) && (t += ""), !he.isString(t))
                      ) {
                        e.next = 16;
                        break;
                      }
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 36:
                      ...
                      throw Object.assign(
                        new de("Network Error", de.ERR_NETWORK, t, A),
    ...
    Ot = function (e) {
      for (
        ...
        (t = i[a]),
          void 0 === (r = s.get(t)) && s.set(t, (r = a ? new Map() : wt(n))),
          (s = r);
      return r;
    };
  Ot();
  ...
  var xt = function (e) {
    ...
    kt = function (e, t) {
      for (
        var r, n, o = (e = he.isArray(e) ? e : [e]).length, i = {}, a = 0;
        a < o;
        a++
      ) {
        var s = void 0;
        if (
          ((n = r = e[a]),
          !Rt(r) && void 0 === (n = St[(s = String(r)).toLowerCase()]))
        )
